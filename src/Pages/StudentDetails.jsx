...
const StudentDetails = () => {
    ...
    const filterStudentHelper = async () => {
        try {
            const { data } = await axios({
                method: 'Post',
                url: 'https://iiitl-attendance-backend.onrender.com//api/student/getAllStudents',
                data: {
                    department,
                    year,
                    section
    ...
    const filterByNameHelper = async () => {
        try {
            const { data } = await axios({
                method: 'Post',
                url: 'https://iiitl-attendance-backend.onrender.com//api/student/getStudentByName',
                data: {
                    name
                }
            })
